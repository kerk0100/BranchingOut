...
router.post('/', function (req, res, next) {
  const coffeeShop = {_id: uuid() ,name: req.body.name, image:req.body.image, hours: req.body.hours}
  const review = {_id: uuid(),  text: req.body.text, author: req.body.author, coffeeShop: coffeeShop};
  reviews.push(review);
